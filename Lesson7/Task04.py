...
# которая проверяет, все ли элементы в 
# objects дают одинаковое значение характеристики func
# Аргументы:
...
print(same_by(lambda x: x[1], ["qz", "qz1", "qz", "qz", "qz", "qz", "qz", "qz"]))
print(same_by1(lambda x: x[1], ["qz", "qz1", "qz", "qz", "qz", "qz", "qz", "qz"]))