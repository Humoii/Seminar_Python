...
# Curabitur a tellus ut arcu gravida porta eget a lacus.
# Curabitur ornare varius turpis, ultricies mollis sem convallis in.
...
print(len(set(text.split())))# .split - разбивает строку, по умолчанию по пробелу
